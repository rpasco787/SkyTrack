...
class OutboundFlightTest {
    ...
    void shouldConstructWithAllFields() {
        var flight = new OutboundFlight("UA", "1234", "N12345", "ORD", "LAX", 1773090000L, 900L);
        ...
        assertThat(flight.destAirportIata()).isEqualTo("LAX");
    ...
    void shouldAllowNullActualDelay() {
        var flight = new OutboundFlight("UA", "1234", "N12345", "ORD", "LAX", 1773090000L, null);
